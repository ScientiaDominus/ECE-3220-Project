...
class Character : public Entity{
	public: 
		...
		CharacterClass intToClass(int class_); // this converts an integer into a CharacterClass enum
		Race intToRace(int race_); // this converts an integer into a Race enum
